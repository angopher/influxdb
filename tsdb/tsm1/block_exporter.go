...
type SQLBlockExporter struct {
	...
	firstRecord bool // true after first record written
...
CREATE TABLE IF NOT EXISTS blocks (
	...
	fmt.Fprintln(e.w, `INSERT INTO blocks (filename, org_id, bucket_id, key, type, min_time, max_time, checksum, count) VALUES`)
